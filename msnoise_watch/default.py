...
default['wct_ns'] = ["smoothing parameter in frequency","5.0", float]
default['wct_nt'] = ["smoothing parameter in time","5.0", float]
default['wct_vpo'] = ["spacing param between discrete scales","20.0", float]
default['wct_freqmin'] = ["minimum frequency for the wavelet","0.1", float]
default['wct_freqmax'] = ["maximum frequency for the wavelet","8.0", float]
default['wct_nptsfreq'] = ["number of freq points between min and max","300.0", float]
default['dtt_freqmin'] = ["minimum frequency for dtt","0.1", float]
default['dtt_freqmax'] = ["maximum frequency for dtt","8.0", float]
default['dtt_codacycles'] = ["number of cycles of period (1/freq) between lag_min and lag_max","20", int]
default['dvv_min_nonzero'] = ["percentage of data points with non-zero weighting required for regression, otherwise nan (0 to 1)","0.25", float]
default['wct_norm'] = ["Is the REF and CCF are normalized before computing wavelet? [Y]/N", "Y", bool]
