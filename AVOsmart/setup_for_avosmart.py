...
file_name = 'compile_msnoise_B2.py'
...
print(f"*** Don't forget to modify data_location, data_output, start_date and end_date in {new_folder}/compile_msnoise_B2.py ***")
print("Run the new script with the following command:")
print(f"conda activate {env_name} && python {new_folder}/compile_msnoise_B2.py")
