...
1. run add_pram_moving_ref, to modify and add two parameters that where not in the original config. (use command line like python add_param_moving_ref.py --begin_ref -10)
