                    ...
                    if ref_type == 'moving':
                        ...
                        if ref_end_param == 'auto':
                            ...
                            if ref_end >= current_stack_start:
                                logger.warning(
                                    ...
                                    f"{pair} {component} f{filterid} m{mov_stack} @ {date.date()}")
                        ...
                        if separation > expected_sep:
                            logger.warning(
                                ...
                                f"ref_end={window_data.index[-1].date()}, current={date.date()}, "
...
def save_day_wct_results_adaptive(station1, station2, date, component, filterid, mov_stack, 
                                 taxis, dvv, err, coh, freqs, inx, coda_diagnostics, curr_window_days, ref_window_days, step_days, ref_lag_days, separation):
    """
